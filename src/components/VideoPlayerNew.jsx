        ...
        {showControls && (
          <>
            ...
            <div className="absolute top-4 right-4">
              <button
                onClick={onClose}
                className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full text-2xl font-bold transition-colors shadow-lg"
                title="Close Player"
              >
                ✕
              </button>
            ...
            {/* Movie Info Overlay (only for YouTube videos) */}
            {youtubeVideoId && (
